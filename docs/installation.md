...
### Windows 11 (x64)
1. Download `BioDockify-Docking-Studio.exe` from the [Latest Release](https://github.com/tajo9128/Docking-studio/releases/download/v1.0.73/BioDockify-Docking-Studio.exe).
